...
namespace MyActivityLibrary.Design {
    ...
    public partial class MyActivityDesigner : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MyActivityDesigner).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MyActivityDesigner));
        ...
        private string FindResource() {
            string[] resources = typeof(MyActivityDesigner).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MyActivityDesigner.g.xaml") || resource.Equals("MyActivityDesigner.g.xaml"))) {
                    return resource;
                }
            }
